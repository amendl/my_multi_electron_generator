...
# which /sps/nemo/scratch/amendl/AI/ExAegir/_build.d/exaegir-config > /dev/null 2>&1
# if [ $? -ne 0 ]; then
#     my_exit 1 "exaegir is not available! Abort!"
# fi

exaegirLibDir=$(/sps/nemo/scratch/amendl/AI/ExAegir/_build.d/exaegir-config --libdir)

echo "[my info] ${exaegirLibDir}"
...
flsimulate-configure --no-gui \
		     -M  \
		     -H  \
		     -L "exaegir@$(/sps/nemo/scratch/amendl/AI/ExAegir/_build.d/exaegir-config --libdir)" \
